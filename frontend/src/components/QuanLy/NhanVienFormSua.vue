<template>
     <Form @submit="$emit('suaNhanVien-submit', nhanvienMoi)" :validation-schema="schema">
          ...
          <div class="row container-fluid content" style="height: 650px; overflow-y:auto; overflow-x:hidden;">
               <div class="form-group">
                    <label for="maNV">Mã</label>
                    <Field name="maNV" type="name" class="form-control" v-model="nhanvienMoi.NV_Ma" :disabled="true" />
               ...
               <div class="form-group">
                    ...
                    <Field name="gioitinhNV" class="form-control" placeholder="" v-model="nhanvienMoi.NV_GioiTinh">
                         ...
                         <input v-if="nhanvienMoi.NV_GioiTinh" type="radio" id="one" value="true"
                              v-model="nhanvienMoi.NV_GioiTinh" @click="setGioiTinh(true)" checked="true" />
                         <input v-if="!nhanvienMoi.NV_GioiTinh" type="radio" id="one" value="true"
                              v-model="nhanvienMoi.NV_GioiTinh" @click="setGioiTinh(true)" />
                         <label for="one">Nam &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>

                         <input v-if="!nhanvienMoi.NV_GioiTinh" type="radio" id="two" value="false"
                              v-model="nhanvienMoi.NV_GioiTinh" @click="setGioiTinh(false)" checked="true" />
                         <input v-if="nhanvienMoi.NV_GioiTinh" type="radio" id="two" value="false"
                              v-model="nhanvienMoi.NV_GioiTinh" @click="setGioiTinh(false)" />
               ...
               <div class="form-group">
                    ...
                    <div style="border: solid 0.1px #cecaca; border-radius: 5px;">
                         <Field name="matkhauNV" class="form-control" v-model="nhanvienMoi.password" type="password"
                              style="width:95%; display: inline; border: none;" />
                    </div>
               ...
               <div class="form-group">
                    ...
                    <Field name="khoaTKNV" class="form-control" v-model="nhanvienMoi.NV_KhoaTaiKhoan">
                         <input v-if="!nhanvienMoi.NV_KhoaTaiKhoan" type="radio" id="one" value="false" name="khoaTKNV"
                              v-model="nhanvienMoi.NV_KhoaTaiKhoan" @click="setKhoaTaiKhoan(false)" checked="true" />
                         <input v-if="nhanvienMoi.NV_KhoaTaiKhoan" type="radio" id="one" value="false" name="khoaTKNV"
                              v-model="nhanvienMoi.NV_KhoaTaiKhoan" @click="setKhoaTaiKhoan(false)" />
                         <label for="one">Mở khóa &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>

                         <input v-if="nhanvienMoi.NV_KhoaTaiKhoan" type="radio" id="two" value="true" name="khoaTKNV"
                              v-model="nhanvienMoi.NV_KhoaTaiKhoan" @click="setKhoaTaiKhoan(true)" checked="true" />
                         <input v-if="!nhanvienMoi.NV_KhoaTaiKhoan" type="radio" id="two" value="true" name="khoaTKNV"
                              v-model="nhanvienMoi.NV_KhoaTaiKhoan" @click="setKhoaTaiKhoan(true)" />
