     ...
     <Form @submit="$emit('themNhanVien-submit', nhanvienMoi)" :validation-schema="schema">
          <div class="row container-fluid content" style="height: 650px; overflow-y: auto; overflow-x: hidden">
               ...
               <div class="form-group">
                    ...
                    <Field name="hoNV" class="form-control" v-model="nhanvienMoi.NV_Ho" placeholder="Nhập họ nhân viên" />
                    <ErrorMessage name="hoNV" class="error-feedback" />
               </div>
               <div class="form-group">
                    <label for="tenNV">Tên</label>
                    <Field name="tenNV" class="form-control" v-model="nhanvienMoi.NV_Ten" placeholder="Nhập tên nhân viên" />
               ...
               <div class="form-group">
                    ...
                    <Field name="ngaysinhNV" class="form-control" v-model="nhanvienMoi.NV_NgaySinh" placeholder="Ngày sinh">
               ...
               <div class="form-group">
                    ...
                    <Field name="gioitinhNV" class="form-control" placeholder="" v-model="nhanvienMoi.NV_GioiTinh">
                         ...
                         <input type="radio" id="nam" value="true" v-model="nhanvienMoi.NV_GioiTinh"
                              @click="setGioiTinh(true)" />
                         <label for="one">Nam &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>

                         <input type="radio" id="nu" value="false" v-model="nhanvienMoi.NV_GioiTinh"
               ...
               <div class="form-group">
                    ...
                    <Field name="sdtNV" class="form-control" v-model="nhanvienMoi.NV_SDT" placeholder="Nhập số điện thoại" />
               ...
               <div class="form-group">
                    ...
                    <Field name="diachiNV" class="form-control" v-model="nhanvienMoi.NV_DiaChi" placeholder="Nhập địa chỉ" />
               ...
               <div class="form-group">
                    ...
                    <Field name="loaiNV" class="form-control" v-model="nhanvienMoi.NV_LoaiNV" placeholder="Chức vụ: ">
               ...
               <div class="form-group">
                    ...
                    <Field name="khoaTKNV" class="form-control" v-model="nhanvienMoi.NV_KhoaTaiKhoan">
                         <input type="radio" id="mokhoa" value="false" v-model="nhanvienMoi.NV_KhoaTaiKhoan"
                              @click="setKhoaTaiKhoan(false)" />
                         <label for="one">Mở khóa &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>

                         <input type="radio" id="khoa" value="true" v-model="nhanvienMoi.NV_KhoaTaiKhoan"
          ...
          <div class="form-group">
               ...
               <div class="row">
                    <button class="btn btn-primary mx-auto" style="font-size: 20px">THÊM NHÂN VIÊN</button>
