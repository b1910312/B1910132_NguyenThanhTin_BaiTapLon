<template>
    <Form @submit="$emit('suaSanPham-submit', sanphamLocal)" :validation-schema="schema" enctype="multipart/form-data">
        ...
        <div class=" container-fluid" style="height:650px; overflow-y:auto; overflow-x: hidden;">

            <div class="form-group">
                <label style="font-size: 25px" for="ma">Mã sản phẩm</label>
            ...
            <div class="form-group">
                <label style="font-size: 25px" for="ID_Catalog">Danh mục sản phẩm</label><br>
                <Field v-if="!chonDanhMuc" name="ID_Catalog" type="name" class="form-control" v-model="sanphamLocal.DM_Ten"
                    @click="chonDanhMuc = true" />
                <Field v-if="chonDanhMuc" name="ID_Catalog" type="name" class="form-control" v-model="sanphamLocal.DMSP_Ma">
            ...
            <div class="form-group">
                <label style="font-size: 25px" for="ID_Branch">Thương hiệu</label>
                ...
                <Field v-if="chonThuongHieu" name="ID_Branch" type="name" class="form-control" v-model="sanphamLocal.TH_Ma">
            ...
            <div class="form-group">
                <label style="font-size: 25px" for="name">Tên sản phẩm</label>
                <Field name="name" class="form-control" v-model="sanphamLocal.SP_TenSanPham"
                    placeholder="Nhập tên sản phẩm" />
                <ErrorMessage name="name" class="error-feedback" />
            </div>
            <div class="form-group">
                <label style="font-size: 25px" for="information">Mô tả</label>
            ...
            <div class="form-group">
                <label style="font-size: 25px" for="quality">Số lượng</label>
            ...
            <div class="form-group">
                <label style="font-size: 25px" for="purchase_price">Giá nguyên liệu</label>
            ...
            <div class="form-group">
                <label style="font-size: 25px" for="saleprice">Giá bán ra</label>
            ...
            <div class="form-group">
                <label style="font-size: 25px" for="image">Hình ảnh &nbsp; &nbsp;</label>
                <Field name="image" class="form-control " v-model="sanphamLocal.SP_HinhAnh" @click="chonHinhAnh = true">
                    <input type="file" ref="file" name="image" @change="selectFile" accept="image/*" class=""
        ...
        <div class="form-group ">
            ...
            <div class="row">
                <button class="btn btn-success mx-auto">CẬP NHẬT SẢN PHẨM</button>
