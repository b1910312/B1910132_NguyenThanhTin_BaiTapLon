...
<template>
    <div class="">
        ...
        <div class="container frameDangNhap" style="height: 99vh; max-width: 200%;">
                    ...
                    <div class="row">
                        <Form @submit="handleRegister" :validation-schema="schema" v-slot="{ isSubmitting }">
                            <div class="form-group">
                                <label for="KH_Ten" style="font-size: 30px;">Tên tài khoản</label>
                            ...
                            <div class="form-group">
                                <label for="xacNhanMatKhau" style="font-size: 30px;">Nhập lại mật khẩu</label>
                                <div class="row" style="background-color: #F5F4F4; border-radius: 15px; margin: 0 0 0 0;">
                            ...
                            <div class="form-group mt-5 btn-login" style="margin-bottom:0%">
                                <button class="btn btn-sm btn-primary btn-block btnDangKy" style="background-color: blue;"
                                    :disabled="isSubmitting" :class="{ 'submitting': isSubmitting }">
                                    <span v-show="loading" class="spinner-border spinner-border-sm"></span>
                                    <span style="font-size: 30px;">Đăng Ký</span>
                                </button>
                            </div>
                            <div class="textDangNhap" >
                                <p class="labelCoTaiKhoan" style="font-size: 20px;">Bạn đã có tài khoản?<button style="font-size: 30px;" @click="goToDangNhap" href="" class="btnDangNhap"> Đăng Nhập</button></p>
                            </div>
                        </Form>
